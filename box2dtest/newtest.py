...
from Box2D import (b2FixtureDef, b2PolygonShape, b2_pi, b2CircleShape)
...
class Tumbler(Framework):
    ...
    def __init__(self):
        ...
        self.joint = self.world.CreateRevoluteJoint(bodyA=ground, bodyB=body,
                                                    ...
                                                    referenceAngle=0, motorSpeed=0.1 * b2_pi,
    ...
    def Step(self, settings):
        ...
        self.world.CreateDynamicBody(
            ...
            fixtures=b2FixtureDef(
                density=1.0, friction=100, shape=b2CircleShape(radius=0.2)),
            linearVelocity=(5, 5)
        )
